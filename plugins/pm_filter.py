...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>ɪꜰ yᴏᴜ ɴᴇᴇᴅ ᴍᴏᴠɪᴇ ᴊᴏɪɴ @MOTIONFILMS ᴀɴᴅ ᴀꜱᴋ !</b>")
    ...
    if query.data.startswith("file"):
     ...
     #Any Ertors In Thos Code Contact @Master_broi
       ...
       await query.answer()
        ...
        buttons = [[
            InlineKeyboardButton('🪄ᴀʟʟ ᴏᴜʀ ʟɪɴᴋꜱ🪄', url="t.me/MM_DISCUSSI0NS")
       ],[
            InlineKeyboardButton('🎬ɢʀᴏᴜᴘ🎬', url="t.me/MOTIONFILMS"),
            InlineKeyboardButton('🏅ᴄʜᴀɴɴᴇʟ🏅', url="t.me/KOMOFFICIAL")
       ],[
            InlineKeyboardButton('📣ʙᴏᴛ ᴜᴩᴅᴀᴛᴇꜱ📣', url="t.me/CURSED_LORD"),
            InlineKeyboardButton('🤖ꜱᴜᴘᴘᴏʀᴛ🤖', url="https://t.me/OFFICIALBOT_SUPPORT")
       ],[
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⌫ ʙᴀᴄᴋ", callback_data="start"),
                    InlineKeyboardButton("☎️Cᴏɴᴛᴀᴄᴛ☎️", url="t.me/CURSED_LORD")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
